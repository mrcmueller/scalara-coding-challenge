...
export function beziehungenControllerAendereBeziehung(http: HttpClient, rootUrl: string, params: BeziehungenControllerAendereBeziehung$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
